...
namespace {
const Real rho_unit = 1.163966380896591e-11;
const Real cs_unit = 2950027.133301406;
...
Real EquationOfState::PresFromRhoEg(Real rho, Real egas) {
  ...
  return pressureEq(temperature,rho)/(rho_unit*cs_unit*cs_unit);
}
...
Real EquationOfState::EgasFromRhoP(Real rho, Real pres) {
  ...
  return energyEq(temperature, rho)/(rho_unit*cs_unit*cs_unit);
}
