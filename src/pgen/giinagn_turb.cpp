...
// a more complicated setup
                        ...
                        if (std::abs(radflx) > er)
                        {
                          radflx = -5e-15; -1.21103e-10;// -0.000340914;//-6.21433391e-11;//-3.11584e-16;//-1.11e-11;//-1.24457e-11;//-7.43161e-16;//-1.84e-16;//-1.24457e-11;//-6.73678e-12;//-1.42311025e-08;// -1.79191e-11;//-1.18124e-10;//-1.2e-8;//2.01906e-14;//-7.16367e-08;//-1.1e-10;//-1.24937e-11;//3.e-8;//-2.57125e-09;//-2.30161e-09;//-1.24937e-19;//2.57125e-09;//-1.9075e-09;//-1.42311e-08;//-6.39973e-09;//-6.43605e-09;//-5.92373e-09;// -3.15383e-08;//-3.49145e-09;//-5.20708e-15;//-6.8314e-09;//-1.90e-8;//3.54e-14;//1.60138e-08;//-5.0929e-10;//3.54e-14;//-4.057e-8;//-1.72121e-08;//-5.12837e-08;//-2.04063e-11;//3.70352e-10; //need to tune this to be equal to the Erad constant
                          er =  5e-15; 1.21103e-10;// 0.000340914;//5.80428e-15;//6.21433391e-11;//3.11584e-16;//1.11e-11;//1.24457e-11;//7.43161e-16;//1.84e-16;//1.24457e-11;//6.73678e-12;//1.42311025e-08;//1.79191e-11;//1.18124e-10;1.2e-8;//2.01906e-14;//7.16367e-08;//1.1e-10;//1.24937e-11;//3.e-8;//2.57125e-09;//2.30161e-09;//1.24937e-19;//2.57125e-09;//1.9075e-09;//1.42311e-08; //6.39973e-09;//5.92373e-09;//3.15383e-08;//3.49145e-09;//5.20708e-15;//6.8314e-09;//1.90e-8;//5.0929e-10;//4.057e-08;//5.12837e-08;//8.87961e-08;//-2.04063e-11;
                        }
