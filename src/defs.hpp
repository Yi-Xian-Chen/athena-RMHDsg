...
// problem generator
#define PROBLEM_GENERATOR "giinagn_radmhd_blockfft"
...
#define COMPILED_WITH_OPTIONS " -O3 -std=c++11  -L/usr/local/hdf5/gcc/openmpi-4.1.0/1.10.6/lib64  -lfftw3 -lhdf5" // NOLINT
